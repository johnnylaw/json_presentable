...
describe JSONPresentable::PresenterMethodMaker do
  describe '#print' do
    context 'when errors option is false' do
      subject { JSONPresentable::PresenterMethodMaker.new('page', method_name: '_default_map', errors: false, &block).print }
      ...
      describe '#not_attributes' do
        ...
        context 'when called WITHOUT arguments' do
          ...
          subject { -> { JSONPresentable::PresenterMethodMaker.new('page', method_name: '_default_map', &block).print } }
    ...
    context 'when :errors option is true' do
      ...
      subject { JSONPresentable::PresenterMethodMaker.new('page', method_name: '_default_map', errors: true, &block).print }
    ...
    context 'when errors option is set to a string or symbol' do
      let(:block) { proc { attributes :title } }
      subject { JSONPresentable::PresenterMethodMaker.new('page', method_name: '_default_map', errors: 'issues(14)', &block).print }
